...
It is also important that choosing smoothing kernel have significant impact on stability and correctness. \cite{Monaghan1992} discusses impact of smoothing kernel on error of integral interpolant. \cite{Muller03} points out that gradient o kernel used for computing pressure force should not approach zero when $r$ approaches zero. This would lead to creation of particle clusters as pressure force would decrease when particles are closer to each other.
