#include "FountainSceneBuilder.h"
#include "MyFluid.h"


FountainSceneBuilder::FountainSceneBuilder(void)
{
}
...
void FountainSceneBuilder::buildScene(NxScene* nxScene, ConfigurationFactory& configurationFactory, bool accelerateFluid)
{
	try {
